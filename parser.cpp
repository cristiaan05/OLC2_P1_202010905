...
#undef YYCASE_
  ...
  Parser::yystos_[] =
  {
       0,    12,    15,    16,     7,     0,    16,     3,    17,    18,
       5,     6,     8,     9,    10,    13,    18,    18,    11,     3,
       3,     3
  };
  ...
  {
  "END", "error", "\"invalid token\"", "NUMERO", "ID", "SUMA", "MENOS",
  "PARIZQ", "PARDER", "POR", "DIVIDIDO", "PYCOMA", "EVALUAR", "MODULO",
  "$accept", "listasentencias", "sentencia", "expresion", "expresion2", YY_NULLPTR
  };
#endif
  ...
  Parser::yyrline_[] =
  {
       0,    87,    87,    91,    97,   104,   108,   112,   118,   124,
     130,   136
  };
