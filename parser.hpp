...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      // expresion
      // expresion2
      char dummy1[sizeof ( Proyecto1::Expresion* )];

      // sentencia
      char dummy2[sizeof ( Proyecto1::Sentencia )];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_PARDER = 8,                            // PARDER
        S_POR = 9,                               // POR
        S_DIVIDIDO = 10,                         // DIVIDIDO
        S_PYCOMA = 11,                           // PYCOMA
        S_EVALUAR = 12,                          // EVALUAR
        S_MODULO = 13,                           // MODULO
        S_YYACCEPT = 14,                         // $accept
        S_listasentencias = 15,                  // listasentencias
        S_sentencia = 16,                        // sentencia
        S_expresion = 17,                        // expresion
        S_expresion2 = 18                        // expresion2
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_expresion2: // expresion2
        value.move<  Proyecto1::Expresion*  > (std::move (that.value));
        break;

      case symbol_kind::S_sentencia: // sentencia
        value.move<  Proyecto1::Sentencia  > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t,  Proyecto1::Expresion* && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const  Proyecto1::Expresion* & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t,  Proyecto1::Sentencia && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const  Proyecto1::Sentencia & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      case symbol_kind::S_expresion: // expresion
      case symbol_kind::S_expresion2: // expresion2
        value.template destroy<  Proyecto1::Expresion*  > ();
        break;

      case symbol_kind::S_sentencia: // sentencia
        value.template destroy<  Proyecto1::Sentencia  > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_PARIZQ (location_type l)
      {
        return symbol_type (token::PARIZQ, std::move (l));
      }
#else
      static
      symbol_type
      make_PARIZQ (const location_type& l)
      {
        return symbol_type (token::PARIZQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_PARDER (location_type l)
      {
        return symbol_type (token::PARDER, std::move (l));
      }
#else
      static
      symbol_type
      make_PARDER (const location_type& l)
      {
        return symbol_type (token::PARDER, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_POR (location_type l)
      {
        return symbol_type (token::POR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::POR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_DIVIDIDO (location_type l)
      {
        return symbol_type (token::DIVIDIDO, std::move (l));
      }
#else
      static
      symbol_type
      make_DIVIDIDO (const location_type& l)
      {
        return symbol_type (token::DIVIDIDO, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_PYCOMA (location_type l)
      {
        return symbol_type (token::PYCOMA, std::move (l));
      }
#else
      static
      symbol_type
      make_PYCOMA (const location_type& l)
      {
        return symbol_type (token::PYCOMA, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_EVALUAR (location_type l)
      {
        return symbol_type (token::EVALUAR, std::move (l));
      }
#else
      static
      symbol_type
      make_EVALUAR (const location_type& l)
      {
        return symbol_type (token::EVALUAR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      case symbol_kind::S_expresion: // expresion
      case symbol_kind::S_expresion2: // expresion2
        value.copy<  Proyecto1::Expresion*  > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_sentencia: // sentencia
        value.copy<  Proyecto1::Sentencia  > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      case symbol_kind::S_expresion: // expresion
      case symbol_kind::S_expresion2: // expresion2
        value.move<  Proyecto1::Expresion*  > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_sentencia: // sentencia
        value.move<  Proyecto1::Sentencia  > (YY_MOVE (s.value));
        break;
